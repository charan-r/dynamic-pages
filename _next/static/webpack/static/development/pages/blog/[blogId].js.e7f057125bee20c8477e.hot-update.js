  ...
  return _babel_runtime_corejs2_regenerator__WEBPACK_IMPORTED_MODULE_1___default.a.async(function fetchData$(_context2) {
    while (1) {
      switch (_context2.prev = _context2.next) {
        case 0:
          id = next_router__WEBPACK_IMPORTED_MODULE_4___default.a["router"] && next_router__WEBPACK_IMPORTED_MODULE_4___default.a["router"]["asPath"].split("/")[2];
          console.log("refreshedProps", id); // ${router['router']['asPath'].split('/')[2]

          _context2.next = 4;
          return _babel_runtime_corejs2_regenerator__WEBPACK_IMPORTED_MODULE_1___default.a.awrap(isomorphic_unfetch__WEBPACK_IMPORTED_MODULE_3___default()("https://jsonplaceholder.typicode.com/todos/".concat(id, "}")));
...
//# sourceMappingURL=[blogId].js.e7f057125bee20c8477e.hot-update.js.map