  ...
  return _babel_runtime_corejs2_regenerator__WEBPACK_IMPORTED_MODULE_1___default.a.async(function fetchData$(_context2) {
    while (1) {
      switch (_context2.prev = _context2.next) {
        case 0:
          router = next_router__WEBPACK_IMPORTED_MODULE_4___default.a;
          console.log("dsfdsfdsf", router);
          _context2.next = 4;
          return _babel_runtime_corejs2_regenerator__WEBPACK_IMPORTED_MODULE_1___default.a.awrap(isomorphic_unfetch__WEBPACK_IMPORTED_MODULE_3___default()("https://jsonplaceholder.typicode.com/todos/".concat(router['router']['asPath'].split('/')[2])));
...
//# sourceMappingURL=[blogId].js.1abaa6129a4eca78851e.hot-update.js.map